...
default['openstack']['object-storage']['git_builder_ip'] = 'controller'
...
default['openstack']['object-storage']['swift_url']             = 'http://controller:8080/v1/'
default['openstack']['object-storage']['swauth_url']            = 'http://controller:8080/v1/'
default['openstack']['object-storage']['auth_url']              = 'http://controller:8080/auth/v1.0'
# Keystone version
...
default['openstack']['object-storage']['statistics']['statsd_host'] = 'controller'
...
default['openstack']['object-storage']['network']['proxy-cidr']               = '192.168.122.0/24'
...
default['openstack']['object-storage']['network']['object-cidr']              = '192.168.122.0/24'
...
default['openstack']['object-storage']['account-server']['mount_check'] = false
...
# Whether or not check if the devices are mounted to prevent accidentally writing to
# the root device. The default is set to true.
default['openstack']['object-storage']['container-server']['mount_check'] = false
...
# Whether or not check if the devices are mounted to prevent accidentally writing to
# the root device. The default is set to true.
default['openstack']['object-storage']['object-server']['mount_check'] = false
...
# zone
#---------
default['openstack']['object-storage']['zone'] = 'r1z1';
