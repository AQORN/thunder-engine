...
# install keystone middleware
installSourcePythonPackage('pbr-0.10.8.tar.gz')
installSourcePythonPackage('netifaces-0.10.4.tar.gz')
installSourcePythonPackage('oslo.utils-1.4.0.tar.gz')
installSourcePythonPackage('msgpack-python-0.4.6.tar.gz')
installSourcePythonPackage('oslo.serialization-1.4.0.tar.gz')
installSourcePythonPackage('pycadf-0.8.0.tar.gz')
installSourcePythonPackage('python-keystoneclient-1.3.0.tar.gz')
installSourcePythonPackage('keystonemiddleware-1.5.0.tar.gz')

# commented to replace with above code
#execute 'fix python packages dependency' do
#  command "easy_install keystonemiddleware"
#  action :run
#end
