...
default['openstack']['block-storage']['verbose'] = 'True'
default['openstack']['block-storage']['debug'] = 'True'
...
#default['openstack']['block-storage']['volume']['driver'] = 'cinder.volume.drivers.rbd.RBDDriver';
...
default['openstack']['block-storage']['volume']['create_volume_group'] = true
...
default['openstack']['block-storage']['volume']['create_volume_group_type'] = 'block_devices'
# String of local disk device paths
# Examples: '/dev/sdx /dev/sdx1' or '/dev/sd[k-m]1'
default['openstack']['block-storage']['volume']['block_devices'] = '/dev/sdb1'

default['openstack']['block-storage']['volume']['iscsi_helper'] = 'tgtadm'
default['openstack']['block-storage']['volume']['iscsi_ip_address'] = node['thunder']['node_ip']
...
default['openstack']['block-storage']['rbd_secret_name'] = 'ceph_secret_uuid'
