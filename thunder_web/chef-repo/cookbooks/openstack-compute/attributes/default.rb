...
default['openstack']['compute']['vif_plugging_timeout'] = 0
...
default['openstack']['compute']['ceph_active'] = false
default['openstack']['compute']['libvirt']['volume_backend'] = nil
default['openstack']['compute']['libvirt']['rbd']['rbd_secret_name'] = 'ceph_secret_uuid'
...
default['openstack']['compute']['block-storage']['cinder_catalog_info'] = 'volume:cinder:publicURL'
