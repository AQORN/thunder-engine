...
default['openstack']['network']['dhcp']['dnsmasq_url'] = node['thunder']['pkg_download_url'] + "/dnsmasq-2.65.tar.gz"
...
default['openstack']['network']['openvswitch']['tunnel_id_ranges'] = '1:1000'
...
default['openstack']['network']['openvswitch']['bridge_mappings'] = 'external:br-ex'
...
default['openstack']['network']['ml2']['type_drivers'] = 'gre,vlan,flat'
...
default['openstack']['network']['ml2']['tenant_network_types'] = 'gre,vlan'
...
default['openstack']['network']['ml2']['tunnel_id_ranges'] = '1:1000'
